				...
				<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
						...
						<ul class="nav side-menu">
							...
							<li><a><i class="fa fa-user"></i> My Account <span class="fa fa-chevron-down"></span></a>
								<ul class="nav child_menu" style="display: none">
									...
									--}}
                                    {{--<li class=" disabled text-capitalize"><a href="#">Your Roles</a></li>--}}
					...
					<div class="menu_section">
						...
						<ul class="nav side-menu">
							{{--
							<li>
								<a><i class="fa fa-user"></i> Accounts <span class="fa fa-chevron-down"></span></a>
								<ul class="nav child_menu" style="display: none">
									<li><a href="{{ url('/') }}accounts?show=list">List</a></li>
									<li><a href="{{ url('/') }}accounts?show=add&csrf={{ csrf_token() }}">Add</a>
									</li>
								</ul>
							</li>
							--}}
							<!-- navigation links -->
								@foreach( config('mnara_menu.navigation') as $nav_menu )
									<li>
										<a><i class="{{$nav_menu['class']}}"></i><span class="sr-only"> {{$nav_menu['group']}}</span>{{$nav_menu['group']}} <span class="fa fa-chevron-down"></span></a>
										<ul class="nav child_menu" style="display: none">
				...
				<nav class="" role="navigation">
					...
					{{--
						...
						<li role="presentation">
							<a href="{{ url('/') }}notifications" alt="See All Notifications">
								<i class="fa fa-envelope-o"></i>
							</a>
						</li>
						{/if}
