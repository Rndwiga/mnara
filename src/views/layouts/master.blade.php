	...
	<nav class="navbar navbar-default navbar-fixed-top">
	    <div class="container">
	        <div class="navbar-header">
	            ...
	            <a class="navbar-brand" href="{{ route( config('mnara.route.as').'index') }}">{{ $title }}</a>
	        </div>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					@else
				        ...
				        <li class="dropdown">
				          ...
				          <ul class="dropdown-menu">
				            <li><a href="{{ route( config('mnara.route.as') . 'index') }}"><i class="fa fa-fw fa-tasks"></i> Dashboard</a></li>
    						
    						<li role="separator" class="divider"></li>
    						<li class="text-muted text-center"><i class="fa fa-users"></i> Your Roles</li>
							@forelse(Auth::user()->roles as $role)
								<li><a href="{{ route( config('mnara.route.as') . 'role.permission.edit', $role->id) }}"><i class="fa fa-users fa-xs"></i> {{ $role->name }}</a></li>
							@empty
